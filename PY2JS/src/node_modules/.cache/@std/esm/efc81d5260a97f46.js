"main";_60a‍.e([["scanTokens",()=>scanTokens]]);let error;_60a‍.w('./ProgramConverter.mjs',[["error",function(v){error=v}]]);let TokenType;_60a‍.w('./TokenType.mjs',[["TokenType",function(v){TokenType=v}]]);let Token;_60a‍.w('./Token.mjs',[["Token",function(v){Token=v}]]);
...
keywords.set("as", AS);
keywords.set("assert", ASSERT);
keywords.set("async", AYNC);
keywords.set("await", AWAIT);
keywords.set("break", BREAK);
